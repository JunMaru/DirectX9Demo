...
public:
	...
	void SetBlurFlg(bool flg){ m_bDrawBlurModel = flg; }
	void SetBlurTexture(LPDIRECT3DTEXTURE9 pTex);
...
protected:
	...
	CShadowTexture* m_pShadowTextureShader;
	CBlur* m_pBlurShader;
	...
	bool m_bDrawBlurModel;

	void DrawToonModel(void);
	void DrawShadowTexture(void);
	void DrawBlurModel(void);
};
